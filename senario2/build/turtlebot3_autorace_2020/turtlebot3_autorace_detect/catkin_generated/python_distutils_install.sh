...
echo_and_run cd "/home/hosna/Desktop/project/senario2/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hosna/Desktop/project/senario2/src/turtlebot3_autorace_2020/turtlebot3_autorace_detect/setup.py" \
     \
    build --build-base "/home/hosna/Desktop/project/senario2/build/turtlebot3_autorace_2020/turtlebot3_autorace_detect" \
    install \
    --root="${DESTDIR-/}" \

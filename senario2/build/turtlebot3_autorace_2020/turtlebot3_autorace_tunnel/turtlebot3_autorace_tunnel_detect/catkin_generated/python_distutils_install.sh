...
echo_and_run cd "/home/hosna/Desktop/project/senario2/src/turtlebot3_autorace_2020/turtlebot3_autorace_tunnel/turtlebot3_autorace_tunnel_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/hosna/Desktop/project/senario2/src/turtlebot3_autorace_2020/turtlebot3_autorace_tunnel/turtlebot3_autorace_tunnel_detect/setup.py" \
     \
    build --build-base "/home/hosna/Desktop/project/senario2/build/turtlebot3_autorace_2020/turtlebot3_autorace_tunnel/turtlebot3_autorace_tunnel_detect" \
    install \
    --root="${DESTDIR-/}" \
